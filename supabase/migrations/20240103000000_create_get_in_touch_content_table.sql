-- Migration: Create get_in_touch_content table
-- Description: Stores editable content for the "Get in Touch" section on the homepage

-- Create get_in_touch_content table (singleton pattern - only one row should exist)
...
-- Ensure only one row exists in get_in_touch_content
...
-- RLS Policies for get_in_touch_content
