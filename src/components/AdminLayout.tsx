    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-background border-b">
        <div className="flex items-center justify-between p-4">
          <h2 className="text-xl font-bold text-primary">LifeBloom Admin</h2>
          <Button
            variant="ghost"
            size="icon"
      ...
      <aside
        className={cn(
          'lg:hidden fixed top-0 left-0 z-40 h-full w-64 bg-background border-r transition-transform duration-300',
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block fixed top-0 left-0 z-30 h-full w-64 bg-background border-r">
        <SidebarContent />
      </aside>
