          ...
          <div className="space-y-8 stagger-animate animate-on-scroll">
            ...
            <div className="space-y-4 stagger-animate animate-on-scroll stagger-1">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                At LifeBloom, we believe that exceptional healthcare should be accessible, personalized, and delivered with genuine care.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 stagger-animate animate-on-scroll stagger-2">
              <div className="glass-card floating-card p-6 hover-lift">
                ...
                <p className="text-muted-foreground">
                  To provide comprehensive, accessible healthcare solutions that empower individuals to live healthier, more fulfilling lives.
                </p>
              </div>
              ...
              <div className="glass-card floating-card p-6 hover-lift">
                ...
                <p className="text-muted-foreground">
                  To be the leading healthcare provider that sets the standard for quality, innovation, and patient-centered care.
                </p>
              </div>
            </div>
