          ...
          <div className="space-y-8 stagger-animate animate-on-scroll stagger-1">
            ...
            <div className="grid sm:grid-cols-2 gap-6 stagger-animate animate-on-scroll stagger-2">
              {contactInfo.map((item, index) => {
                ...
                return (
                  <div key={index} className="glass-card floating-card p-6 hover-lift">
                    <div className={`w-12 h-12 bg-gradient-to-r ${item.color} rounded-xl flex items-center justify-center mb-4 hover-glow`}>
